...
DEFAULT_ENV = /home/$(USER)/share/usr/opt/miniconda/
NEW_ENV = /home/$(USER)/share/usr/anaconda-envs/jrflab-modules-0.1.5/
...
sufam/%.tsv : sufam/%.txt
	$$(call RUN,-c -s 4G -m 6G --default_env $$(DEFAULT_ENV) --env $$(NEW_ENV),"$(RSCRIPT) modules/variant_callers/updateSamples.R --patient $$*")
