...
hla_polysolver/$1_$2/winners.hla.txt : bam/$1.bam bam/$2.bam
	$$(call RUN,-c -s 8G -m 12G,"export CONDA_PREFIX=/home/${USER}/share/usr/anaconda-envs/hla-polysolver && export PERL5LIB=${CONDA_PREFIX}/lib/perl5/5.22.0/ && mkdir hla_polysolver/$1_$2 && \
