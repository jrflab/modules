...
hla_optitype/%.bam : %.bam
	$$(call RUN,-n 4 -s 1G -m 2G,"$(SAMTOOLS2) view -@ 4 $$< 6 -b -o hla_optitype/$$*.bam")

hla_optitype/%_1.fastq hla_optitype/%_2.fastq : hla_optitype/%.bam
	$$(call RUN,-n 4 -s 1G -m 2G,"$(SAMTOOLS2) sort -T $$(<D)/$$* -O bam -n -@ 4 -m 6G $$< | $(SAMTOOLS2) fastq -f 1 -1 > hla_optitype/$$*.1.fastq -2 > hla_optitype/$$*.2.fastq -")

hla_optitype/%_1_razers3.bam hla_optitype/%_2_razers3.bam : hla_optitype/%_1.fastq hla_optitype/%_2.fastq
	$$(call RUN,-n 4 -s 1G -m 2G,"source /home/${USER}/share/usr/anaconda-envs/jrflab-modules-0.1.5/bin/activate \
								  /home/${USER}/share/usr/anaconda-envs/jrflab-modules-0.1.5/ && \
