...
MUTECT2_OPTS ?= --max_alt_alleles_in_normal_count $(MUTECT_MAX_ALT_IN_NORMAL) --max_alt_allele_in_normal_fraction $(MUTECT_MAX_ALT_IN_NORMAL_FRACTION) -R $(REF_FASTA) --dbsnp $(DBSNP)
...
mutect2/chr_vcf/$1_$2.$3.mutect_snps_indels.vcf : bam/$1.bam bam/$2.bam bam/$1.bam.bai bam/$2.bam.bai
	$$(call LSCRIPT_CHECK_MEM,15G,15G,"$$(MUTECT2) --intervals $3 -I:tumor $$< -I:normal $$(<<) -o $$@")
endef
