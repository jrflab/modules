...
crest/sclip/%.$1.sclip.txt crest/sclip/%.$1.cover : bam/%.bam
	$$(call RUN,-c -s 4G -m 6G,"$$(EXTRACT_SCLIP) -i $$< --ref_genome $$(REF_FASTA) -r $1 -o $$(@D) -p $$*")
endef
...
crest/sv/$1_$2.$3.predSV.txt : bam/$1.bam bam/$2.bam crest/sclip/$1.cover 
	$$(call RUN,-c -s 4G -m 6G,"$$(CREST) -p $1_$2.$3 -f $$(<<<) -d $$< -g $$(<<) --ref_genome $$(REF_FASTA) -t $$(REF_2BIT) -r $3")
endef
...
crest/sv/%.$1.predSV.txt : bam/%.bam crest/sclip/%.cover 
	$$(call RUN,-c -s 4G -m 6G,"$$(CREST) -p $$*.$1 -f $$(<<) -d $$< --ref_genome $$(REF_FASTA) -t $$(REF_2BIT) -r $1")
endef
