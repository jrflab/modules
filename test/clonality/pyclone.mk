...
pyclone : $(foreach pair,$(SAMPLE_PAIRS),pyclone/$(pair)/report.tsv) $(foreach pair,$(SAMPLE_PAIRS),pyclone/$(pair)/hist_ccf.pdf) $(foreach pair,$(SAMPLE_PAIRS),pyclone/$(pair)/hist_std.pdf)
...
pyclone/$1_$2/hist_ccf.pdf pyclone/$1_$2/hist_std.pdf : pyclone/$1_$2/pyclone.tsv
	$$(call RUN, -s 16G -m 24G,"mkdir -p pyclone/$1_$2 && \
