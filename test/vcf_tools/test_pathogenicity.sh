...
python ${SCRIPT_DIR}/classify_pathogenicity_vcf.py ${TEST_DATA_DIR}/pathogen_test_indels.vcf > ${OUT_DIR}/pathogen_test_out_indels.vcf
compare_files ${OUT_DIR}/pathogen_test2_out_indels.vcf ${TEST_DATA_OUT_DIR}/pathogen_test2_out_indels.vcf
