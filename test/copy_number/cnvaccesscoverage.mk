...
cnvaccess_coverage : $(foreach sample,$(TUMOR_SAMPLES),cnvaccess/cnn/tumor/$(sample).pool-A.targetcoverage.cnn cnvaccess/cnn/tumor/$(sample).pool-B.targetcoverage.cnn cnvaccess/cnn/tumor/$(sample).no-pool.antitargetcoverage.cnn) $(foreach sample,$(NORMAL_SAMPLES),cnvaccess/cnn/normal/$(sample).pool-A.targetcoverage.cnn cnvaccess/cnn/normal/$(sample).pool-B.targetcoverage.cnn cnvaccess/cnn/normal/$(sample).no-pool.antitargetcoverage.cnn)
