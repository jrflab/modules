...
for (i in 1:length(normal_samples)) {
	system(paste0("cnvkit.py fix cnvkit/cnn/tumor/", tumor_sample, ".targetcoverage.cnn  cnvkit/cnn/tumor/", tumor_sample, ".antitargetcoverage.cnn cnvkit/reference/", normal_samples[i], ".cnr -o cnvkit/cnr/", tumor_sample, ".cnr"))
}
