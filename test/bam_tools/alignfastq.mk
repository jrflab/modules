...
align_fastq : $(foreach sample,$(SAMPLES),marianas/$(sample)/$(sample).std.bam)
...
marianas/$1/$1.dedup.bam : marianas/$1/%.realn.bam
	$$(call RUN, -c -n 1 -s 12G -m 18G -w 7200,"java -Djava.io.tmpdir=$$(TMPDIR) -Xms2G -Xmx16G -jar $$(PICARD_JAR) MarkDuplicates \
												I=$$(<) \
												O=$$(@) \
												M=marianas/$1/$1.txt \
												TMP_DIR=$(TMPDIR)")
marianas/$1/$1.std.bam : marianas/$1/$1.dedup.bam
	$$(call RUN, -c -n 1 -s 12G -m 18G -w 7200,"java -Djava.io.tmpdir=$(TMPDIR) -Xms2G -Xmx16G -jar $$(PICARD_JAR) AddOrReplaceReadGroups \
												I=$$(<) \
												O=$$(@) \
												RGID=$1 \
												RGLB=$1 \
