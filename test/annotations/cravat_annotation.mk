...
cravat/%.vcf : vcf_ann/%.gatk_snps.vcf vcf_ann/%.gatk_indels.vcf
	$$(call RUN,-c -s 9G -m 12G -v $$(DEFAULT_ENV) -w 7200,"$(RSCRIPT) modules/test/annotations/combine_vcf.R --sample_name $$(*)")
...
cravat/%.cravat.vcf : cravat/%.vcf cravat/%.maf
	$$(call RUN,-c -s 9G -m 12G -v $$(DEFAULT_ENV) -w 7200,"$(RSCRIPT) modules/test/annotations/filter_vcf.R --sample_name $$(*)")
...
cravat/%.txt : cravat/%.tsv
	$$(call RUN,-c -s 9G -m 12G -v $$(DEFAULT_ENV) -w 7200,"$(RSCRIPT) modules/test/annotations/summary_vcf.R --sample_name $$(*)")
