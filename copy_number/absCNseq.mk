...
ABS_CN_SEQ = $(RSCRIPT) modules/copy_number/absCNseq.R
...
absCN/$1_$2.gatk.vcf : bam/$1.bam bam/$2.bam
	$$(call RUN,-s 9G -m 12G,"$$(call GATK_MEM,8G) -T UnifiedGenotyper -o $$@ -I $$< -I $$(<<) -R $$(REF_FASTA)  --output_mode EMIT_ALL_SITES -L $$(SNV_POS_FILE)")
endef
...
absCN/%.absCN.txt absCN/%.absSNV.txt : varscan/segment/%.varscan2copynumber.txt absCN/%.gatk.vcf
	$(call RUN,-s 4G -m 6G,"$(ABS_CN_SEQ) --genome $(REF) --outPrefix absCN/$* $^")
