...
ascat/mad/$1_$2.RData : facets/cncf/$1_$2.Rdata
	$$(call RUN,-c -v ~/share/usr/anaconda-envs/ascat -s 3G -m 6G,"if [ -n ${aspcf_gamma.$1+set} ]; then $(RSCRIPT) modules/copy_number/ascat.R --type aspcf --file_in $$< --file_out ascat/mad/$1_$2.RData --gamma $${aspcf_gamma.$1}; else $(RSCRIPT) modules/copy_number/ascat.R --type aspcf --file_in $$< --file_out ascat/mad/$1_$2.RData; fi")
...
ascat/log2nbaf/$1_$2.pdf : ascat/mad/$1_$2.RData
	$$(call RUN,-c -v ~/share/usr/anaconda-envs/ascat -s 3G -m 6G,"$(RSCRIPT) modules/copy_number/ascat.R --type plot-aspcf --file_in $$< --file_out ascat/log2nbaf/$1_$2.pdf")
...
ascat/ascat/$1_$2.pdf : ascat/mad/$1_$2.RData
	$$(call RUN,-c -v ~/share/usr/anaconda-envs/ascat -s 3G -m 6G,"if [ -n ${ascat_rho.$1+set} ]; then $(RSCRIPT) modules/copy_number/ascat.R --type run-ascat --file_in $$< --file_out ascat/ascat/$1_$2.pdf --rho $${ascat_rho.$1} --psi $${ascat_psi.$1}; else $(RSCRIPT) modules/copy_number/ascat.R --type run-ascat --file_in $$< --file_out ascat/ascat/$1_$2.pdf; fi")
