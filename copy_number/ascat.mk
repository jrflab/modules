...
ascat/ascat/$1_$2.pdf : ascat/mad/$1_$2.RData
	$$(call RUN,-c -v ~/share/usr/anaconda-envs/ascat -s 3G -m 6G,"export rho=NA; && \
																   if [ ! -z ${ascat_rho.$1} ]; then export rho=$${ascat_rho.$1}; else export rho=NA; fi; && \
																   if [ ! -z ${ascat_psi.$1} ]; then export psi=$${ascat_psi.$1}; else export psi=NA; fi; && \
