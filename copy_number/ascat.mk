...
ascat : $(foreach pair,$(SAMPLE_PAIRS),ascat/log2/$(pair).pdf ascat/bafall/$(pair).pdf ascat/bafhet/$(pair).pdf ascat/mad/$(pair).RData ascat/log2nbaf/$(pair).pdf ascat/ascat/$(pair).pdf ascat/total/$(pair).pdf ascat/bychr/$(pair)/chromosome_23.pdf)
...
ascat/bychr/$1_$2/chromosome_23.pdf : facets/cncf/$1_$2.Rdata ascat/ascat/$1_$2.pdf
	$$(call RUN,-c -v $(ASCAT_ENV) -s 6G -m 12G,"mkdir -p ascat/bychr/ && \
