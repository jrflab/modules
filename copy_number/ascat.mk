...
ascat/ascat/$1_$2.pdf : ascat/mad/$1_$2.RData
	$$(call RUN,-c -v ~/share/usr/anaconda-envs/ascat -s 3G -m 6G,"if [[ -v ascat_rho.$1 ]]; then $(RSCRIPT) modules/copy_number/ascat.R --type run-ascat --file_in $$< --file_out ascat/ascat/$1_$2.pdf --rho $${ascat_rho.$1} --psi $${ascat_psi.$1}; else $(RSCRIPT) modules/copy_number/ascat.R --type run-ascat --file_in $$< --file_out ascat/ascat/$1_$2.pdf; fi")
