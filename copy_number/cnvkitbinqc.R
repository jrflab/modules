...
plot(bin_size, var_bin_n, type="n", axes = FALSE, frame.plot = FALSE, main = "", xlab = "", ylab = "")
points(x=bin_size, y=var_bin_n, col = "grey50", bg = "grey90", pch = 19, cex = 1, lwd = .1)
...
plot(bin_size, var_bin_t, type="n", axes = FALSE, frame.plot = FALSE, main = "", xlab = "", ylab = "")
points(x=bin_size, y=var_bin_n, col = "salmon", bg = "black", pch = 19, cex = 1, lwd = .1)
axis(1, at = NULL, cex.axis = 1.5, padj = 0.25, lwd=1.25, lwd.ticks=1.15)
axis(2, at = NULL, cex.axis = 1.5, las = 1, lwd=1.25, lwd.ticks=1.15)
mtext(side = 1, text = "Bin size (bp)", line = 4, cex = 1.5)
mtext(side = 2, text = "Variance", line = 4, cex = 1.5)
