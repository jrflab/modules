...
optList <- list(
                ...
                make_option("--lowPlus", default = F, type = "boolean", help = "use only positions with effects annotated as greater than LOW"),
