...
ANN_FIELDS = GENOTYPE ANNOTATION "ANN[*].IMPACT" "ANN[*].GENE" "ANN[*].GENEID" "ANN[*].FEATUREID" "ANN[*].BIOTYPE" "ANN[*].RANK" CODON AA POS_CDNA LEN_CDNA POS_CDS LEN_CDS POS_AA LEN_AA "ANN[*].DISTANCE" WARNING
