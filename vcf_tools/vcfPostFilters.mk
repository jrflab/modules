...
vcf/%.cft.vcf : vcf/%.vcf
	$(call CHECK_VCF,$(call LSCRIPT_CHECK_MEM,8G,12G,"$(call GATK_MEM,8G) -T VariantFiltration -U LENIENT_VCF_PROCESSING -R $(REF_FASTA) -V $< -o $@.tmp \
...
vcf/%.common_ft.vcf : vcf/%.vcf
	$(call CHECK_VCF,$(call LSCRIPT_CHECK_MEM,4G,5G,"$(COMMON_FILTER_VCF) $< > $@.tmp && $(call VERIFY_VCF,$@.tmp,$@)"))
