...
summary/mutation_heatmap_variant.pdf summary/mutation_heatmap_variant_recurrent.pdf summary/mutation_heatmap_ccf.pdf summary/mutation_heatmap_ccf_recurrent.pdf : summary/mutation_summary.xlsx $(foreach pair,$(SAMPLE_PAIRS),facets/$(pair).cncf.txt) $(foreach pair,$(SAMPLE_PAIRS),absolute/reviewed/SEG_MAF/$(pair)_ABS_MAF.txt)
