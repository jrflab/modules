...
run_pyclone : $(foreach sample,$(NORMAL_SAMPLES),pyclone/$(sample)/$(sample).tsv)
...
pyclone/%/%.tsv : pyclone/%/trace/alpha.tsv.bz2
	$$(call RUN,-c -s 4G -m 6G,"source /home/${USER}/share/usr/anaconda-envs/jrflab-modules-0.1.5/bin/activate /home/${USER}/share/usr/anaconda-envs/PyClone-0.13.1 && \
								PyClone build_table --config_file pyclone/$$*/config.yaml --out_file pyclone/$$*/$$*.tsv --max_cluster 10 --table_type old_style --burnin 1000")
endef
