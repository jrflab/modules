...
plot_pyclone : $(foreach sample,$(NORMAL_SAMPLES),pyclone/$(sample)/plots/by_loci_density.pdf) $(foreach sample,$(NORMAL_SAMPLES),pyclone/$(sample)/plots/all_loci_density.pdf) $(foreach sample,$(NORMAL_SAMPLES),pyclone/$(sample)/plots/all_loci_scatter.pdf) $(foreach sample,$(NORMAL_SAMPLES),pyclone/$(sample)/summary.tsv) $(foreach sample,$(NORMAL_SAMPLES),pyclone/$(sample)/plots/all_loci_scatter_2.pdf)
...
pyclone/%/plots/all_loci_scatter_2.pdf : pyclone/%/summary.tsv
	$$(call RUN,-s 4G -m 6G,"source /home/${USER}/share/usr/anaconda-envs/jrflab-modules-0.1.6/bin/activate /home/${USER}/share/usr/anaconda-envs/jrflab-modules-0.1.6/ && \
