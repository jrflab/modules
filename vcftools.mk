...
%.dp_ft.vcf : %.vcf
	$(call LSCRIPT_MEM,8G,12G,"$(call GATK_MEM,8G) -T VariantFiltration -R $(REF_FASTA) -V $< -o $@ --filterName alleleDepth --filterExpression 'vc.hasAttribute(\"AD\") && vc.getAD().1 < $(DEPTH_FILTER)'")
