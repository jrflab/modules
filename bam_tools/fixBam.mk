...
unprocessed_bam/%.dedup.bam : unprocessed_bam/%.fixed.bam
	$$(call RUN, -c -n 1 -s 8G -m 16G,"java -Xmx8G -jar $$(PICARD_JAR) MarkDuplicates I=$$(<) O=unprocessed_bam/$$(*).dedup.bam M=unprocessed_bam/$$(*).txt && rm $$(<)")
fixed_bam/%.bam : unprocessed_bam/%.dedup.bam
	$$(call RUN, -c -n 1 -s 8G -m 16G,"java -Xmx8G -jar $$(PICARD_JAR) AddOrReplaceReadGroups I=$$(<) O=fixed_bam/$$(*).bam RGID=$$(*) RGLB=$$(*) RGPL=illumina RGPU=NA RGSM=$$(*) && samtools index fixed_bam/$$(*).bam && cp fixed_bam/$$(*).bam.bai fixed_bam/$$(*).bai && rm $$(<)")
endef
